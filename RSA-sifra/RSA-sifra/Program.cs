...
namespace RSA_sifra
{
    public class RSA_Sifra
    {
        ...
        public RSA_Sifra(BigInteger p, BigInteger q)
        {
            this.n = BigInteger.Multiply(p,q);
            this.eulerNumb = BigInteger.Multiply((p - 1), (q - 1));
        ...
        public BigInteger RandomIntegerBelow(BigInteger eulerNumb) // to generate a random number
        {
